...
begin
  DECLARE
    ...
    @v_interpolated_line geometry;
  BEGIN
    SET @v_start_measure = [$(lrsowner)].[STPercentageToMeasure](@p_linestring,@p_start_fraction * 100.0);
    SET @v_end_measure   = [$(lrsowner)].[STPercentageToMeasure](@p_linestring,@p_end_fraction   * 100.0);
